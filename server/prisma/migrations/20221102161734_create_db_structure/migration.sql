...
CREATE TABLE "Particiant" (
    ...
    CONSTRAINT "Particiant_poolId_fkey" FOREIGN KEY ("poolId") REFERENCES "Pool" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Guess" (
    ...
    "particiantId" TEXT NOT NULL,
    CONSTRAINT "Guess_particiantId_fkey" FOREIGN KEY ("particiantId") REFERENCES "Particiant" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
